<%@ Page Title="Seach Parts Page" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmSearchParts.aspx.vb" Inherits="Telling___Administration__ASP.NET_.frmSearchParts" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("table#dgvSearch_PartData").dataTable().columnFilter(
                {
            ...
            // -------------  Fixed Header   -------------
            //            oTable = $('#dgvSearch_PartData').dataTable();
            //            new FixedHeader(oTable);

            //$('#dgvSearch_PartData div.title').text("This is a table title");

            /* Add a click handler to the rows - this could be used as a callback */
            $("#dgvSearch_PartData tbody tr").click(function (e) {
            ...
            $('#btnDelete').click(function () {
                ...
                if (anSelected.length !== 0) {
                    ...
                    if (confirm('Are you sure you wish to delete this row?')) {
                        ...
                        $("#dgvSearch_PartData tbody tr").removeClass('row_selected');
                        $('#btnDelete').hide();
                    }
                }
            });
            ...
            $('#dgvSearch_PartData tbody td').click(function () {
...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
        ...
        <section class="featured">
                  <div class="search-parts-content">
                       <%--create a tab structured menu--%>
                      <h2 id="search-parts-header">Search Parts</h2>
                       <table class="search-parts-table">
                           <tr class="table-content">
                               <td>&nbsp;</td>
                           </tr>
                        </table>  
                        <asp:GridView ID="dgvSearch_PartData" runat="server" OnPreRender="Search_PartData_PreRender" ShowFooter="True" ShowHeaderWhenEmpty="True" Height="50px" Width="560px" AutoGenerateColumns="False" DataSourceID="SqlDS" ClientIDMode="Static">
                            <Columns>
                                <asp:BoundField HeaderText="Part_Number" DataField="Part_Number" SortExpression="Part_Number" />
                                <asp:BoundField HeaderText="Part_Description" DataField="Part_Description" SortExpression="Part_Description" />
                            </Columns>
        ...
        <asp:SqlDataSource ID="sqlDS" runat="server" ConnectionString="<%$ ConnectionStrings:TellingConnectionString %>" SelectCommand="SELECT [Part_Number], [Part_Description] FROM [wpParts]"></asp:SqlDataSource>
</asp:Content>